...
namespace AppProfProPartage.ViewModel.Controllers
{
    public class WelcomeController : Controller
    {
        ...
        public String Index()
        {
            return "Bienvenue sur le site ProfProPartage vous permettant de gérer vos favoris ";
        }

        public String Saluer(string prenom , string nom)
        {
            return string.Format("Bienvenue {0} {1} sur le site ProfProPartage vous permettant de gérer vos favoris ", prenom, nom);
        }
