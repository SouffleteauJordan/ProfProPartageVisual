...
namespace ProfProPartage.ViewModel
{
    ...
    public class ViewModelFicheCours : IValidatableObject
    {
        private FicheCours _fiche;
        
        
        public FicheCours FicheCours_inside
        {
            get { return _fiche; }
        }

        public ViewModelFicheCours(FicheCours fic)
        {
            _fiche = fic;
        }

        public ViewModelFicheCours()
        {
            _fiche = new FicheCours();
        }
